...
const translations = {
    ...
    cn: {
        ...
        disclaimerText: "<p>这里的所有光影文件只是我 Seiyant 的编辑作品。我不是这些光影的原创作者，也从未声称是。我只是调整设置使其看起来更好、运行更流畅。所有版权均归原光影开发者所有。</p><p>所有光影设置都是免费的。不要浪费钱购买光影配置，请尊重并支持原创开发者。</p>",
        modpackDisclaimerText: "如果有任何错误或问题，请私信我的账户并确保已关注。",
        modpackDisclaimerTitle: "免责声明",
        ...
        ofText: "/",
        shadersText: "个光影",
        noResultText: "未找到匹配的光影",
        comingSoonTitle: "模组包已准备就绪",
        comingSoonDesc: "达到 2,000 粉丝时将分享模组包。",
        langName: "中文",
        readBtn: "阅读",
        closeBtn: "关闭",
        headerShaders: "光影下载",
        ...
        modpack2Title: "主模组包 (青蛙模组)",
        modpack2Subtitle: "主模组包但加入了青蛙模组。",
        badgeMinecraft: "Minecraft : 1.21.1",
        badgePlatform: "平台 : Fabric Loader 0.19.2",
        badgeBy: "by Seiyant"
    },
    ph: {
...
// Modpack Data - urutan badge: badge1 (Minecraft), badge2 (Platform), badge3 (by Seiyant)
const modpacksData = [
    { 
...
function buildModpackElements() {
    ...
    modpacksData.forEach((modpack, index) => {
        ...
        // Setiap badge dibuat terpisah di badge-row sendiri
        let badgesHTML = modpack.badges.map((badgeKey) => {
            const badgeText = t[badgeKey] || badgeKey;
            // Badge "by Seiyant" menggunakan meta-badge-new (sama seperti shaders)
            if (badgeKey === "badgeBy") {
...
function updateDisclaimerReadButton() {
...
function applyLanguage(lang) {
    ...
    // Rebuild modpack elements with new language
...
function switchTab(tab) {
    ...
    if (tab === 'shaders') {
        ...
        // Rebuild modpack elements when switching to modpacks tab
        buildModpackElements();
    }
}
